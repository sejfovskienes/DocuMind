...
def get_document_metadata_by_id(db: Session, document_id: int) -> ProcessedFileMetadata | None:
...
def save_metadata_object(db: Session, document_id: int, raw_text: str) -> ProcessedFileMetadata:
